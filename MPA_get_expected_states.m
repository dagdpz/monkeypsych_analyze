...
switch type
    case 1 %fixation only
        MA_STATES.all_states    = [MA_STATES.INI_TRI MA_STATES.FIX_ACQ MA_STATES.SAC_INI MA_STATES.SAC_END MA_STATES.REA_INI MA_STATES.REA_END ...
        MA_STATES.MOV_INI MA_STATES.MOV_END MA_STATES.FIX_HOL MA_STATES.SUCCESS MA_STATES.TRI_END MA_STATES.REWARD  MA_STATES.ITI ];
        MA_STATES.state_obs     = MA_STATES.FIX_HOL;
    case 2 % direct movement
        MA_STATES.all_states    = [MA_STATES.INI_TRI MA_STATES.FIX_ACQ MA_STATES.FIX_HOL MA_STATES.TAR_ACQ MA_STATES.SAC_INI MA_STATES.SAC_END MA_STATES.REA_INI MA_STATES.REA_END ... 
        MA_STATES.MOV_INI MA_STATES.MOV_END MA_STATES.TAR_HOL MA_STATES.SUCCESS MA_STATES.TRI_END MA_STATES.REWARD  MA_STATES.ITI];
        MA_STATES.state_obs     = MA_STATES.TAR_ACQ;
    case 2.5 % direct movement with dimmed targets (same states as in memory!)
        MA_STATES.all_states    = [MA_STATES.INI_TRI MA_STATES.FIX_ACQ MA_STATES.FIX_HOL MA_STATES.CUE_ON MA_STATES.MEM_PER MA_STATES.TAR_ACQ MA_STATES.SAC_INI MA_STATES.SAC_END MA_STATES.REA_INI MA_STATES.REA_END ... 
        MA_STATES.MOV_INI MA_STATES.MOV_END MA_STATES.TAR_HOL MA_STATES.SUCCESS MA_STATES.TRI_END MA_STATES.REWARD  MA_STATES.ITI];
        MA_STATES.state_obs     = MA_STATES.TAR_ACQ;
    case 3 % memory tasks
        MA_STATES.all_states    = [MA_STATES.INI_TRI MA_STATES.FIX_ACQ MA_STATES.FIX_HOL MA_STATES.CUE_ON MA_STATES.MEM_PER MA_STATES.TAR_ACQ_INV MA_STATES.SAC_INI MA_STATES.SAC_END MA_STATES.REA_INI MA_STATES.REA_END ...
        MA_STATES.MOV_INI MA_STATES.MOV_END MA_STATES.TAR_HOL_INV MA_STATES.TAR_ACQ MA_STATES.TAR_HOL MA_STATES.SUCCESS MA_STATES.TRI_END MA_STATES.REWARD  MA_STATES.ITI];
    case 4 % delay response
        MA_STATES.all_states    = [MA_STATES.INI_TRI MA_STATES.FIX_ACQ MA_STATES.FIX_HOL MA_STATES.CUE_ON MA_STATES.DEL_PER MA_STATES.TAR_ACQ MA_STATES.SAC_INI MA_STATES.SAC_END MA_STATES.REA_INI MA_STATES.REA_END ...
        MA_STATES.MOV_INI MA_STATES.MOV_END MA_STATES.TAR_HOL MA_STATES.SUCCESS MA_STATES.TRI_END MA_STATES.REWARD  MA_STATES.ITI];
        MA_STATES.state_obs     = MA_STATES.TAR_ACQ;
    case 5 % Match-to-sample task
        MA_STATES.all_states    = [MA_STATES.INI_TRI MA_STATES.FIX_ACQ MA_STATES.FIX_HOL MA_STATES.CUE_ON MA_STATES.MEM_PER MA_STATES.MAT_ACQ MA_STATES.SAC_INI MA_STATES.SAC_END MA_STATES.REA_INI MA_STATES.REA_END ...
        MA_STATES.MOV_INI MA_STATES.MOV_END MA_STATES.MAT_HOL MA_STATES.SUCCESS MA_STATES.TRI_END MA_STATES.REWARD  MA_STATES.ITI];
        MA_STATES.state_obs     = MA_STATES.MAT_ACQ;
    case 6 % Match-to-sample task with masked targets
        MA_STATES.all_states    = [MA_STATES.INI_TRI MA_STATES.FIX_ACQ MA_STATES.FIX_HOL MA_STATES.CUE_ON MA_STATES.MEM_PER MA_STATES.MAT_ACQ_MSK MA_STATES.SAC_INI MA_STATES.SAC_END MA_STATES.REA_INI MA_STATES.REA_END ...
        MA_STATES.MOV_INI MA_STATES.MOV_END MA_STATES.MAT_HOL_MSK MA_STATES.SUCCESS MA_STATES.TRI_END MA_STATES.REWARD  MA_STATES.ITI];
        MA_STATES.state_obs     = MA_STATES.MAT_ACQ_MSK;
end
MA_STATES.ALL                 =[MA_STATES.INI_TRI MA_STATES.FIX_ACQ MA_STATES.FIX_HOL MA_STATES.CUE_ON  MA_STATES.MEM_PER     MA_STATES.DEL_PER     MA_STATES.TAR_ACQ_INV  MA_STATES.TAR_HOL_INV...
    ...
    MA_STATES.SAC_INI MA_STATES.SAC_END MA_STATES.REA_INI MA_STATES.REA_END MA_STATES.MOV_INI MA_STATES.MOV_END];
...
MA_STATES.LABELS            ={'INI','F acq', 'F hold', 'Cue', 'Mem ', 'Delay', 'TI acq', 'TI hold', 'T acq', 'T hold', 'T acq', 'T hold', 'M acq', 'T hold', 'S Ret', 'Suc', 'Suc', 'End','Rew', 'ITI', 'Peri S', 'Post S', 'Peri R', 'Post R', 'Peri M', 'Post M'};
